...
All resources are available in Markdown format, which is a simple, popular, human-readable file type that can be imported into Google Docs, converted into HTML files, or edited on various platforms.
You can download them directly from the GitHub repository [here](https://github.com/michellehoda/writing-group).
